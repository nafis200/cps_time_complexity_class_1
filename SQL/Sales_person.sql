...
select s.name from SalesPerson as s LEFT JOIN (SELECT * from Company as c LEFT JOIN Orders as s ON c.com_id = s.com_id WHERE name = 'RED') as o on s.sales_id = o.sales_id where o.name is NULL
